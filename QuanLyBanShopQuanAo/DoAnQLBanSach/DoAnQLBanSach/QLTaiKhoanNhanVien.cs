...
{
    public partial class QLTaiKhoanNhanVien : Form
    {
        ...
        XuLyQLTaiKhoanNhanVien dt = new XuLyQLTaiKhoanNhanVien();
        private void QLTaiKhoanNhanVien_Load(object sender, EventArgs e)
        {
